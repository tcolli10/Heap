...
class TestHeap(unittest.TestCase):
    ...
    def test_build_heap_2(self):
        h = MaxHeap()
        h.build_heap([1, 2, 3])
        self.assertEqual(h.contents(), [3, 1, 2])
    ...
    def test_09_perc_down(self):
        ...
        h = MaxHeap
        h.items = [0, 2, 9, 8, 6, 5, 7]
        h.current_size = 6
        h.perc_down(h, 1) 
        self.assertEqual(h.contents(h), [9, 6, 8, 2, 5, 7])
    ...
    def test_10_perc_up(self):
        ...
        # test_heap.perc_up(6)
        h = MaxHeap
        h.items = [0, 50, 20, 30, 7, 8, 100]
        h.perc_up(h,6)
        self.assertEqual(h.contents(h), [100, 20, 50, 7, 8, 30])
